...
class home extends page {
	constructor() {
		...
		this.sli_ui = (a, b) => ({t: 'div', cl: 'sli-c', d: {in: a, ty: 'sli'}, at: {'aria-hidden': 'true'}, ch: [
