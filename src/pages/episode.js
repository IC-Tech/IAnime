...
class episode extends page {
	...
	content() {
		...
		var c = a => this.load_ ? undefined : a
		var c_ = a => this.epLoad || this.load_ ? undefined : a
		...
		return ([
			...
			{t: 'div', cl: 'watch', ch: [
				...
				{t: 'div', cl: 'mir', ch: [
					...
					{t: 'div', cl: 'wrp', ch: [
						{t: 'a', cl: [!this.load_ && this.episode.next ? 'c0' : 'nope', this.load_ ? 'skeleton' : 'c0'].filter(a => a), at: {href: c((this.episode.next && this.episode.next.web) || '')}, txt: 'Next'}
					]},
				]}
			]},
			{t: 'div', cl: 'ani', ch: [
