...
class faq extends page {
	constructor() {
		...
		this.faq = [
			...
			{q: 'How to request missing Animes?', ch: ['please contact us, we will add them asap.\n', link({t: 'Request', l: 'https://ic-tech.now.sh/contact.html?product=IAnime&type=Request%20Anime'})]},
			{q: 'Report about broken links', ch: ['please contact us, we will fix it asap.\n', link({t: 'Report', l: 'https://ic-tech.now.sh/contact.html?product=IAnime&type=Broken%20Links'})]},
