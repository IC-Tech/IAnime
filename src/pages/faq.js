...
class faq extends page {
	constructor() {
		...
		this.faq = [
			...
			{q: 'How to request missing Animes?', ch: ['please contact us, we will add them asap. ', link({t: 'Request', l: 'https://ic-tech.now.sh/contact.html?product=IAnime&type=Request%20Anime'})]},
			{q: 'Report about broken links', ch: ['please contact us, we will fix it asap. ', link({t: 'Report', l: 'https://ic-tech.now.sh/contact.html?product=IAnime&type=Broken%20Links'})]},
			{q: 'Can I donate you?', ch: ['sure, thank you very much. ', link({t: 'Paypal', l: 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=9UHGSJ5WXTDGE&source=url'}), ' or ', link({t: 'ko-fi.com/imesh', l: 'https://ko-fi.com/imesh'})]},
			{q: 'Links?', ch: ((a,b=[]) => ([a.forEach(a => [b.push(a[0]), b.push(link({t: a[1], l: a[2]})), b.push({t: 'br'})]), b])[1])([
				['Contacts: ', 'IC-Tech/IAnime', 'https://ic-tech.now.sh/contact.html?product=IAnime'],
				['Developer: ', 'IC-Tech', 'https://ic-tech.now.sh'],
				['Roadmap: ', 'Trello Board', 'https://trello.com/b/viWs81k8/ianime'],
				['Donate: ', 'Paypal', 'https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=9UHGSJ5WXTDGE&source=url'],
