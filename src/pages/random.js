...
import (/* webpackPreload: true */ '../style/random.scss')
...
class random extends page {
	...
	content() {
		...
		return ([
			...
			{t: 'div', cl: 'rand', ch: [
				{t: 'div', cl: 'ra-l', ch: [
					{t: 'a', cl: a('img'), at: [['href', b(this.rand.web)]], s: {'background-image': b(`url(${this.rand.poster || '/images/default/poster_2.jpg'}), url("/images/default/banner.gif")`)}}
				]},
				{t: 'div', cl: 'ra-r', ch: [
